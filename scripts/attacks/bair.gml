...
set_window_value(AT_BAIR, 1, AG_WINDOW_LENGTH_BLADED, 9);
...
set_hitbox_value(AT_BAIR, 4, HG_HEIGHT, 64);
...
set_hitbox_value(AT_BAIR, 4, HG_HITPAUSE_SCALING, .45);
...
set_hitbox_value(AT_BAIR, 4, HG_SPIN_KNOCKBACK_SCALING_BONUS, .3);
