...
set_hitbox_value(AT_UTILT, 1, HG_ANGLE_FLIPPER, 4); //Hitbox, Horz-inwards
//Blade
...
set_hitbox_value(AT_UTILT, 4, HG_ANGLE_FLIPPER, 9); //Hitbox, inwards
...
set_hitbox_value(AT_UTILT, 5, HG_HEIGHT, 64);
