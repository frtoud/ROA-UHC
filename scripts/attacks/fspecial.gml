...
set_hitbox_value(AT_FSPECIAL, 2, HG_VISUAL_EFFECT, 21);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_VISUAL_EFFECT, 21);
...
set_hitbox_value(AT_FSPECIAL, 4, HG_EXTRA_HITPAUSE, 50);
set_hitbox_value(AT_FSPECIAL, 4, HG_VISUAL_EFFECT, 197);
...
set_hitbox_value(AT_FSPECIAL, 5, HG_HITBOX_X, 95);
set_hitbox_value(AT_FSPECIAL, 5, HG_HITBOX_Y, -30);
set_hitbox_value(AT_FSPECIAL, 5, HG_WIDTH, 100);
set_hitbox_value(AT_FSPECIAL, 5, HG_HEIGHT, 160);
...
set_hitbox_value(AT_FSPECIAL, 5, HG_EXTRA_HITPAUSE, 40);
set_hitbox_value(AT_FSPECIAL, 5, HG_VISUAL_EFFECT, 197);
...
set_hitbox_value(AT_FSPECIAL, 6, HG_HITBOX_X, 135);
set_hitbox_value(AT_FSPECIAL, 6, HG_HITBOX_Y, -30);
set_hitbox_value(AT_FSPECIAL, 6, HG_WIDTH, 80);
set_hitbox_value(AT_FSPECIAL, 6, HG_HEIGHT, 260);
