...
set_hitbox_value(AT_DATTACK, 4, HG_SPIN_COST, 2);
set_hitbox_value(AT_DATTACK, 4, HG_ANGLE, 13);
set_hitbox_value(AT_DATTACK, 4, HG_TECHABLE, 1);
set_hitbox_value(AT_DATTACK, 4, HG_BASE_KNOCKBACK, 7.2);
set_hitbox_value(AT_DATTACK, 4, HG_KNOCKBACK_SCALING, .07);
