...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_CUSTOM_GRAVITY, gravity_speed * 1.5);
...
set_window_value(AT_USPECIAL, 5, AG_WINDOW_CUSTOM_GRAVITY, gravity_speed * 0.9);

//endlag
set_window_value(AT_USPECIAL, 6, AG_WINDOW_TYPE, 7); //pratfall
