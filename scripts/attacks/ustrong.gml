...
set_hitbox_value(AT_USTRONG, 1, HG_UHC_MULTIHIT_FLIPPER, ANGLE_FLIPPER_AUTOLINK);
...
set_hitbox_value(AT_USTRONG, 2, HG_UHC_MULTIHIT_FLIPPER, ANGLE_FLIPPER_CD_MULTIHIT);
...
set_hitbox_value(AT_USTRONG, 3, HG_SPIN_KNOCKBACK_SCALING_BONUS, 0.25);
