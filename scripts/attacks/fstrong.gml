...
set_hitbox_value(AT_FSTRONG, 1, HG_UHC_MULTIHIT_FLIPPER, ANGLE_FLIPPER_AUTOLINK);
set_hitbox_value(AT_FSTRONG, 1, HG_HITSTUN_MULTIPLIER, 0.3);
...
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_DESTROY_EFFECT, 1); //none
...
set_hitbox_value(AT_FSTRONG, 2, HG_UHC_MULTIHIT_FLIPPER, ANGLE_FLIPPER_CD_MULTIHIT);
...
set_hitbox_value(AT_FSTRONG, 3, HG_PROJECTILE_DESTROY_EFFECT, 1); //none
...
set_hitbox_value(AT_FSTRONG, 3, HG_HITSTUN_MULTIPLIER, 0.8);
set_hitbox_value(AT_FSTRONG, 3, HG_BASE_KNOCKBACK, 7.5);
set_hitbox_value(AT_FSTRONG, 3, HG_KNOCKBACK_SCALING, 0.85);
...
set_hitbox_value(AT_FSTRONG, 3, HG_SPIN_KNOCKBACK_SCALING_BONUS, 0.35);
